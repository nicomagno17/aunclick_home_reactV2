...
export function ProductCard({ product }: ProductCardProps) {
  ...
  const [showInfoPopup, setShowInfoPopup] = useState(false) // State to control the info popup visibility
  ...
  return (
    <>
      <div 
        className="group h-full bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 flex flex-col min-w-[160px] sm:min-w-[200px] md:min-w-[240px]"
      >
        {/* Parte Superior - Imagen más grande para touch */}
        <div 
          className="relative aspect-[4/3] sm:aspect-[3/3] overflow-hidden bg-white"
