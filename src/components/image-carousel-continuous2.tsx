...
export function ImageCarouselContinuous2({ images, autoPlayInterval = 6000, showSource = false, sourceNames = [] }: ImageCarouselContinuous2Props) {
  ...
  return (
    <div className="w-full bg-gray-50 py-6 h-64">
      <div className="w-full h-full overflow-hidden">
        <div 
          className="flex transition-transform duration-1000 ease-in-out"
          style={{ transform: `translateX(-${(currentIndex * 100) / itemsPerView}%)` }}
        >
          {/* Versión Desktop: 12 imágenes, mostrando 3 a la vez */}
                ...
                <div className="relative group overflow-hidden mx-1 h-full">
                  ...
                  <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <div className="text-white text-center">
                      <div className="text-sm font-semibold">Imagen {index + 1}</div>
                    </div>
                  </div>
